  ...
  EasyOOP.extend(cAnimationBase, $this, {
    ...
    animate: function() {
      ...
      this.bufferCtx.drawImage(this.cl,
        ...
        Math.floor(cl1X), 0, this.buffer.width + 1, this.cl.height / 2 + 1,
        //0, 0, this.buffer.width, this.cl.height / 2
        -Math.floor((cl1X * 1000) % 1000) / 1000, 0, this.buffer.width + 1, this.cl.height / 2 + 1
      )
      /**/
      /**/
      this.bufferCtx.drawImage(this.cl,
        //cl2X, this.cl.height / 2, this.buffer.width, this.cl.height / 2,
        Math.floor(cl2X), this.cl.height / 2, this.buffer.width + 1, this.cl.height / 2 + 1,
        //0, 0, this.buffer.width, this.cl.height / 2
        -Math.floor((cl2X * 1000) % 1000) / 1000, 0, this.buffer.width + 1, this.cl.height / 2 + 1
      )
      /**/
      //console.log(cl1X)
      /**/
...
cAnimationMap = (function() {
  ...
  EasyOOP.extend(cAnimationBase, $this, {
    ...
    animate: function() {
      console.log("SDFDF");
      this.bufferCtx.drawImage(this.map,
        this.x, this.y, this.buffer.width, this.buffer.height,
        0, 0, this.buffer.width, this.buffer.height
      )
    },

    moveTo: function(x, y) {
      this.x = x + this.buffer.width > this.map.width ? this.map.width - this.buffer.width : (x < 0 ? 0 : x)
      this.y = y + this.buffer.height > this.map.height ? this.map.height - this.buffer.height : (y < 0 ? 0 : y)
    },
  });
